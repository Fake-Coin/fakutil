...
// Tx returns a wrapped transaction (fakutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (fakutil.Tx) for all
...
// instead provides easy access to wrapped versions (fakutil.Tx) of them.
