...
func NewCoin(index int64, value fakutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = fakutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = fakutil.NewTxFromBytes(testSimpleCoinTxBytes)
