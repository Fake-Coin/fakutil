...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := fakutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*fakutil.AddressPubKeyHash, error) {
	pkHash := fakutil.Hash160(k.pubKeyBytes())
	return fakutil.NewAddressPubKeyHash(pkHash, net)
}
